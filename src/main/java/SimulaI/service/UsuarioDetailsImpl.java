...
/**
 * Adapta Usuario para o contrato UserDetails do Spring Security. Fica restrito à
 * camada de autenticação/autorização — nunca é exposto como resposta de Controller.
 */
